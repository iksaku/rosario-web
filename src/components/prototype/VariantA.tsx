          ...
          if (s.id === 'misterios' && 'misterios' in s) {
            return (
              <section id="misterios" class="mb-12">
                ...
                {s.misterios.map((set) => (
                  <details class="group mb-4 rounded-xl border-2 border-stone-200 bg-white dark:border-stone-700 dark:bg-stone-900">
                    <summary class="flex min-h-[64px] cursor-pointer list-none items-center justify-between px-5 py-4 text-xl font-semibold text-stone-800 dark:text-stone-100">
                      <span>{set.label}</span>
